...
- 词错误率：**23.8%**（125,000 词汇表）
- 词错误率：**9.1%**（50 词受限词汇表；比前一代 SOTA 少 2.7 倍错误）
  - ⚠ 2026-08-02 更正：此前本条目误把 9.1% 记为「phoneme 错误率」，原文 abstract 明确其为**50 词词汇表下的 word error rate**
- 解码速度 62 词/分（前纪录的 3.4 倍；自然对话约 160 词/分）
